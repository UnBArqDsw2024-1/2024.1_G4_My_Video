...
**3. Implementação o Adapter:** Utilizamos o typescript para implementar de maneira prática o que estava definido de maneira conceitual pelos diagramas
...
|  1.5   |    24/07/2024     |      Adicionada sessão de Aplicação      | [Caetano](https://github.com/caeslucio) |  [Marcelo Magalhães](https://github.com/marrcelo) | 24/07/2024 |
