...
- `midia-factory.ts`:
  ![Figura 1 - Midia Factory](https://github.com/UnBArqDsw2024-1/2024.1_G4_My_Video/blob/main/docs/assets/img/factory_method/midia-factory.png)  
  **Figura 1 - Midia Factory.** (Fonte: Catlen Cleane e Gabriel Zaranza . 2024)

- `filme-factory.ts`:
  ![Figura 2 - Filme Factory](https://github.com/UnBArqDsw2024-1/2024.1_G4_My_Video/blob/main/docs/assets/img/factory_method/filme-factory.png)  
  **Figura 2 - Filme Factory.** (Fonte: Catlen Cleane e Gabriel Zaranza . 2024)

- `serie-factory.ts`:
  ![Figura 3 - Serie Factory](https://github.com/UnBArqDsw2024-1/2024.1_G4_My_Video/blob/main/docs/assets/img/factory_method/serie-factory.png)  
  **Figura 3 - Serie Factory.** (Fonte: Catlen Cleane e Gabriel Zaranza  . 2024)

**Models:**

- `filme.ts`:
  ![Figura 4 - Filme Model](https://github.com/UnBArqDsw2024-1/2024.1_G4_My_Video/blob/main/docs/assets/img/factory_method/filme.png)  
  **Figura 4 - Filme Model.** (Fonte: Catlen Cleane e Gabriel Zaranza . 2024)

- `serie.ts`:
  ![Figura 5 - Serie Model](https://github.com/UnBArqDsw2024-1/2024.1_G4_My_Video/blob/main/docs/assets/img/factory_method/serie1.png)  
...
| :----: | :---------------: | :------------------------------: | :-------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------: | :-------------: |
|  1.0   |    15/08/2024     |    Introdução, reutilização usando factory method  | [Lucas Lobão](https://github.com/lucaslobao-18), [Catlen Cleane](https://github.com/catlenc) e [Gabriel Zaranza](https://github.com/GZaranza) | | |
|  1.1   |    15/08/2024     |    Inserindo conclusão do documento.  | [Gabriel Rosa](https://github.com/gabrielrosa09) | | |