...
| :----: | :---------------: | :-------------------------------: | :---------------------------------------------: | :---------------------------------------------: | :-------------: |
|  1.0   |       04/04       |         Criação do documento        | [Gabriel Zaranza](https://github.com/GZaranza) |[Catlen Cleane](https://github.com/catlenc) e [Lucas Ribeiro](https://github.com/lucassouzs)|07/04|
