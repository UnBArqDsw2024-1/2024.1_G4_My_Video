...
- Pair Programming: Adotamos o Pair Programming, onde dois ou tres membros trabalham juntos em um mesmo artefato, promovendo a colaboração, a revisão tempo real e a transferência de conhecimento entre os membros da equipe.
...
|  1.2  |       06/04       |         Introdução de metodologia      | [Catlen Cleane](https://github.com/catlenc) |||
|  1.3  |       07/04       |         Adição de tópicos do XP Adaptado      | [Ana Beatriz](https://github.com/a) |||
